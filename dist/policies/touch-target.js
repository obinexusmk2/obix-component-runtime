...
export function applyTouchTargetPolicy(logic) {
    ...
    if (minWidth < 44 || minHeight < 44) {
        throw new PolicyViolationError('TouchTargetPolicy', `Component "${logic.name}" touch target ${minWidth}x${minHeight}px is below WCAG 2.1 minimum of 44x44px.`);
    }
    return logic;
}
