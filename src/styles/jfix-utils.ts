 ...
 */
export function jfixApplyStrategy(element: Element, strategy: JfixStrategy): void {
 ...
 */
export function jfixRemoveStrategy(element: Element): void {
 ...
 */
export function jfixGetStrategy(element: Element): JfixStrategy | null {
