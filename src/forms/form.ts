...
function computeFormValid(fields: Record<string, FieldState>): boolean {
...
export function createForm(config: FormConfig): ComponentLogicWithAccessibility<FormState> {
  ...
  const logic: ComponentLogicWithAccessibility<FormState> = {
    name: 'ObixForm',
    state: {
